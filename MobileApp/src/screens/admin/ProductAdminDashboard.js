...
const styles = StyleSheet.create({
  ...
  districtChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20, backgroundColor: '#f1f5f9', borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  cancelModalBtn: { flex: 1, padding: 15, borderRadius: 10, borderWidth: 1, borderColor: '#cbd5e1', alignItems: 'center' },
  ...
  receiptCard: { backgroundColor: '#f8fafc', padding: 25, borderRadius: 15, width: '100%', borderWidth: 1, borderColor: '#e2e8f0' },
  receiptBrand: { fontSize: 20, fontWeight: 'bold', color: '#059669', textAlign: 'center', marginBottom: 15 },
  receiptDashed: { borderWidth: 1, borderStyle: 'dashed', borderColor: '#cbd5e1', marginBottom: 15 },
  ...
  imagePicker: { width: '100%', height: 150, borderRadius: 15, backgroundColor: '#f1f5f9', borderWidth: 1, borderStyle: 'dashed', borderColor: '#cbd5e1', justifyContent: 'center', alignItems: 'center', marginBottom: 20, overflow: 'hidden' },
