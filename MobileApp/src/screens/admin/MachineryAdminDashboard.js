...
const styles = StyleSheet.create({
  ...
  statCard: { width: '48%', padding: 15, borderRadius: 16, borderWidth: 1, marginBottom: 12, alignItems: 'center' },
  ...
  editInput: { borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 4, width: 50, textAlign: 'center', backgroundColor: '#fff' },
  ...
  addForm: { backgroundColor: '#f1f8f4', padding: 15, borderRadius: 12, marginTop: 10, borderWidth: 1, borderColor: '#d1fae5' },
  formLabel: { fontSize: 12, fontWeight: '700', color: '#1e293b', marginBottom: 4 },
  input: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, padding: 10, marginBottom: 12, fontSize: 14 },
  formRow: { flexDirection: 'row', marginBottom: 12 },
  pickerSubstitute: { backgroundColor: '#fff', paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderColor: '#d1d5db' },
  ...
  imagePicker: { width: '100%', height: 150, borderRadius: 12, backgroundColor: '#fff', borderWidth: 1, borderStyle: 'dashed', borderColor: '#cbd5e1', justifyContent: 'center', alignItems: 'center', marginBottom: 15, overflow: 'hidden' },
